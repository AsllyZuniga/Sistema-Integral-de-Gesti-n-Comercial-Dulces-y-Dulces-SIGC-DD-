...
@Component({
  selector: 'app-impacto-proveedor-upload',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="cuota-section">
      <h3>Cuotas de impactos por proveedor</h3>
      <p class="section-desc">
        Carga un archivo CSV con las cuotas de impactos por proveedor para cada vendedor y período.
      </p>
...
export class ImpactoProveedorUploadComponent {
  ...
  cargar(): void {
    ...
    this.cuotasService.uploadImpactosProveedor(this.archivoSeleccionado).subscribe({
      next: (res: any) => {
        this.estado = 'exito';
        this.resultado = res;
