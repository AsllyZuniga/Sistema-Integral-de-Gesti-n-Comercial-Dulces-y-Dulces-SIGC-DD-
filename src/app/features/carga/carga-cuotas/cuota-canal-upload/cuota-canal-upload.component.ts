...
@Component({
  selector: 'app-cuota-canal-upload',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="cuota-section">
      <h3>Cuota mensual por canal</h3>
      <p class="section-desc">
        Carga un archivo CSV con cuotas por canal de venta.
      </p>
      ...
      <div class="upload-card">
        ...
        >
          ...
          @if (!archivoSeleccionado) {
            ...
            <p class="upload-hint">Formato: <strong>Canal, Cuota</strong> · Máx. 10 MB</p>
          } @else {
...
export class CuotaCanalUploadComponent {
  ...
  cargar(): void {
    ...
    this.cuotasService.uploadCuotasCanal(this.archivoSeleccionado).subscribe({
