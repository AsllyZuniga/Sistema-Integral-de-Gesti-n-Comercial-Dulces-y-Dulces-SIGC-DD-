...
@Component({
  ...
  template: `
    <div class="cuota-section">
      <h3>Cuota mensual por categoría</h3>
      <p class="section-desc">
        Carga un archivo CSV con cuotas por categoría de producto.
      </p>
      ...
      <div class="upload-card">
        ...
        >
          ...
          @if (!archivoSeleccionado) {
            ...
            <p class="upload-hint">Formato: <strong>Categoría, Cuota</strong> · Máx. 10 MB</p>
          } @else {
