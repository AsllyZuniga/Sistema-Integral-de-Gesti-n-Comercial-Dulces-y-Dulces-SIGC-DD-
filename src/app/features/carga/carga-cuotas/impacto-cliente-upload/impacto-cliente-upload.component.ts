...
@Component({
  selector: 'app-impacto-cliente-upload',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div class="cuota-section">
      <h3>Cuotas de impactos por cliente</h3>
      <p class="section-desc">
        Carga un archivo CSV con las cuotas de impactos por cliente para cada vendedor y período.
      </p>
...
export class ImpactoClienteUploadComponent {
  ...
  cargar(): void {
    ...
    this.cuotasService.uploadImpactosCliente(this.archivoSeleccionado).subscribe({
      next: (res: any) => {
        this.estado = 'exito';
        this.resultado = res;
