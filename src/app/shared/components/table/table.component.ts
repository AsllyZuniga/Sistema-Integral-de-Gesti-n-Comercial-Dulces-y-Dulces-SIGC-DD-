...
export class TableComponent {
  ...
  // ── Formato de celda ──────────────────────────────
  private readonly currencyCols  = new Set(['cuotaMes', 'ventaAcum', 'proyeccionVenta']);
  private readonly percentCols   = new Set(['porcCump', 'porcCumProy']);
  private readonly integerCols   = new Set(['Venta_Unid_Cajas']);
  ...
  // ── Clase CSS por valor (para colorear porcentajes) ──
